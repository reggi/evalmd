...
var files = argv._;
if (files.length) {
    evalMarkdown(files, argv.package, argv.path, argv.block, argv.nonstop, argv.prevent, argv.include, argv.silent, argv.debug, argv.output, argv.delimeter).then(function (report) {
